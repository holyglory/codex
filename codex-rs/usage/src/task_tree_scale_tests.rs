...
async fn large_task_tree_includes_all_descendants_and_agent_totals() {
    ...
    for index in 0..141 {
        ...
        store
            .ensure_thread(&NewThread {
                ...
                source_kind: ThreadSourceKind::new("subagent").expect("source"),
                created_at_ms: 900,
            })
            .await
            .expect("child");
        store
            .ensure_agent(&NewAgent {
                ...
                role_kind: AgentRoleKind::new("worker").expect("role"),
                created_at_ms: 900,
            })
            .await
            .expect("agent");
    ...
    let summary = store
        .task_tree_summary(TaskTreeSummaryQuery {
            ...
            time_range: UtcTimeRange::new(900, 2_001).expect("range"),
        })
        .await
        .expect("summary")
        .expect("tree");
    ...
    assert_eq!(
        ...
        TaskTreeEffort {
            operations: 141,
            model_requests: 141,
            provider_total_tokens: tokens(1_410),

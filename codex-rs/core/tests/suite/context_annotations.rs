...
async fn first_request_item_types_roles_and_content_annotations() -> Result<()> {
    ...
    message developer ["generic.developer_instructions","token_budget.context_window_guidance","permissions.instructions","environments.instructions","usage_stats.instructions"]

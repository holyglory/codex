...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(
        ...
        let mut widget = Self {
            ...
            requires_openai_auth,
            has_codex_backend_auth,
            local_usage_supported: false,
            account_profiles_supported: false,
            model_catalog,
            ...
            next_local_usage_request_id: 0,
            pending_local_usage_request: None,
            next_account_profiles_request_id: 0,
            pending_account_profiles_request: None,
            account_profiles: Vec::new(),
            account_auto_selection_enabled: None,

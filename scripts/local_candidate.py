        ...
        "bazel-layout": (
            [
                *bazel,
                ...
                "--test_tmpdir=/tmp/b",
                "--sandbox_writable_path=/tmp",
                "--sandbox_tmpfs_path=/tmp",
                "--test_env=TMPDIR=/tmp",
                "--test_env=TEST_TMPDIR=/tmp",
                "--test_env=HOME=/tmp/codex-test-home",

...
attribution (DEC-CODEX-001, DEC-CODEX-002). Development tracks the newest
explicitly approved, verified stable upstream release rather than a moving
branch or prerelease tag (DEC-CODEX-017). The machine's local accounts are one operator

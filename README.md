...
### Installing a published Codex Multi release

After a downstream release has been explicitly published, install it on a
supported platform:
...
<details>
<summary>When one has been published, you can also use the <a href="https://github.com/holyglory/codex/releases/latest">latest downstream GitHub Release</a>.</summary>
